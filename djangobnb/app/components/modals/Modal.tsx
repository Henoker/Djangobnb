...
const Modal: React.FC<ModalProps> = ({label, content, isOpen}) => {
  ...
  return (
    <div className="flex items-center justify-center fixed insert-0 z-50 bg-black/60">
        <div className="relative w-[90%] md:w-[100%] lg:w-[700] my-6 mx-auto h-auto">
            <div className={`translate duration-600 h-full ${showModal ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-10'}`}>
                <div className="w-full h-auto bg-white rounded-xl relative flex flex-col">
